<script lang="ts">
	...
	/**
	 * Фотографии разделов — свои, снятые участниками проекта. У остальных
	 * разделов плитка остаётся с рисунком, пока не появится снимок по теме:
	 * плохое фото хуже честного значка.
	 *
	 * Если однажды сюда попадёт чужой снимок — под плитками должна вернуться
	...
	const PHOTOS: Record<string, string> = {
		...
		oral_history: '/photos/wakhan.jpg'
	};
...
<section class="find">
	...
	<p class="credits">
		...
		<a href="https://commons.wikimedia.org/wiki/File:Wakhan,_Tajikistan_(43456807284).jpg">Wakhan</a>,
		Ninara, <a href="https://creativecommons.org/licenses/by/2.0/">CC BY 2.0</a>.
		Рубоб и чириб сняты участниками проекта.
	</p>
</section>
